...
import 'package:flutter_firebase/SuccessRegister.dart';
        ...
        child: ListView(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                const Text('If you already registered your email,'),
                TextButton(
                  child: const Text('Login with your email.'),
                  onPressed: (){
                    Navigator.pop(context);
